...
public class Connection {
	...
	public static void insertRecordIntoDbUserTable() throws SQLException {
		...
		try {
			...
			dbConnection = (Connection) singletonDBAccess.db.conn;
			...
			PreparedStatement pstmt = (PreparedStatement) ((java.sql.Connection) dbConnection).prepareStatement(insertSql);
